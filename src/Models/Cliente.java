...
public class Cliente{
     ...
     * Construtor sem ID
     * @param nome o Nome
     * @param dataDeNascimento a Data_de_Nascimento
     * @param pais a País
     ...
     */
    public Cliente(String nome, Date dataDeNascimento, String pais, String estado, String cidade, String email, String telefone, float limiteDeCredito){
        this.nome = nome;
    ...
    public Cliente(long clienteID, String nome, Date dataDeNascimento, String pais, String estado, String cidade, String email, String telefone, float limiteDeCredito){
     ...
     * @param dataDeNascimento atribui um valor a vareavel dataDeNascimento
     */
